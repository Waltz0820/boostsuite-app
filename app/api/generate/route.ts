...
const CORE_PROMPT      = CORE_PROMPT_V207 || "You are Boost Suite v2.0.7 Perfect Warmflow refiner.";
      ...
      messages: [
        { role: "system", content: CORE_PROMPT },
        {
          ...
          content: [
            ...
            "",
            "Warmflow Rules:",
            "1. 詩的→実利→情緒の流れを維持し、静かな温度で語る。",
            "2. SmartBullet（1〜4機能／5情緒）の構造を保持する。",
            "3. 句読点は呼吸のリズムとして『、』は1文に2回まで。",
            "4. リードには感覚動詞を最低1つ含める（灯る／包み込む／整える 等）。",
            "5. クロージングは所有後の未来や習慣化を必ず含める。",
            "6. 見出し構成は変更せず、削除・追加を禁止。",
            "7. 情緒語は静的表現を優先（例：穏やかに／やさしく／静かに）。",
            "",
            "— Stage1（素体） —",
            stage1,
          ].join("\n"),
