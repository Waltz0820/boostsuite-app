  ...
  try {
    ...
    if (FINAL_POLISH_MODEL) {
      ...
      const polishUser = [
        ...
        "10. 栄養成分（例：オメガ3、ビタミンB1など）に触れている文は、『健康に良い』『栄養バランスが良い』といった結論づけを避け、",
        "    『味わい』『食べやすさ』『日々の献立に取り入れやすい』など、“風味や使いやすさ”の印象レベルに着地させてよい。",
        "11. 3.5 注意事項は、食品らしい基本事項にとどめる。",
        ...
        "",
        "編集スタイル：",
        "12. 原則として、新しい文を一から書き足すことは避ける。既存の文を整理して短くする・2文を1文にまとめるなど、",
        "    「削る」「整える」方向を優先する。どうしても必要な場合のみ、既存内容の言い換えレベルで1文程度なら追加してよい。",
        "13. SNS要約には、保存方法や注意事項（『※〜にご注意ください』など）は含めない。すでに含まれている場合は削除してよい。",
        "",
        "参考情報：",
