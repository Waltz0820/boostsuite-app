  ...
  return (
    <>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <div className="mt-8 flex gap-4">
              <a href="/tool" className="px-5 py-3 rounded-md bg-zinc-900 text-white hover:opacity-90">無料で試す</a>
              <a href="/pricing" className="px-5 py-3 rounded-md border hover:bg-zinc-50">価格を見る</a>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="mt-8">
          <a href="/tool" className="px-5 py-3 rounded-md bg-zinc-900 text-white hover:opacity-90">今すぐ試す</a>
        </div>
      </section>
