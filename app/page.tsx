...
export default function Page() {
  return (
    <>
      ...
      <FAQ
  items={[
    { q: "無料でも制限なく使えますか？", a: "初回30クレジットまで完全無料でご利用いただけます。登録不要で、今すぐお試しいただけます。" },
    { q: "クレジットって何ですか？", a: "各生成時に消費される単位です。追加購入や繰り越しも可能です。" },
    { q: "英語や中国語の商品説明にも対応していますか？", a: "はい。自動的に検知して、自然な日本語に整流します。" },
    { q: "途中解約はいつでもできますか？", a: "はい。いつでも解約可能で、以降の請求は発生しません。" },
    { q: "クレジットカードは必須ですか？", a: "無料トライアルでは不要です。契約時のみ入力をお願いしています。" },
    { q: "クレジットの有効期限はありますか？", a: "有効期限はありません。未使用分は翌月以降も繰り越してご利用いただけます。" },
    { q: "CSV一括生成は何件まで対応していますか？", a: "Proプランでは1回あたり1,000件を目安としています。今後さらに拡張予定です。" },
  ]}
/>
    </>
  );
